...
/**
 * @description Um componente de página que fornece uma interface com abas para gerenciar fornecedores, produtos e conversões de unidades.
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Organize fornecedores, produtos e conversões em um só lugar."
      />
